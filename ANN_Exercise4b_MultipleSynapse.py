...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 18 10:41:53 2019

Multiple synapse firing rate
...
TODO: We will no longer use evenly distributed dt_shift for each input
spike firing times, we will vary the input ifiring by choose random
distribution of firing times, gaussian and regular sequential for
comparing the effect of input spike to output synapse
